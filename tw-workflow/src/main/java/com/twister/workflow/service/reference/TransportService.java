...
import com.twister.repository.reference.TransportRepository;
import com.twister.payload.TransportFilter;
import com.twister.repository.specification.TransportSpecification;
...
public class TransportService {
    ...
    public Page<Transport> getAllTransport(TransportFilter filter, Pageable pageable) {
        Specification<Transport> specification = TransportSpecification.search(filter);
    ...
    public void create(Transport transport) {
        ...
        Transport dbTransport = transportRepository.save(transport);
    ...
    public void update(Transport transport) {
        ...
        transportRepository.save(dbTransport);
